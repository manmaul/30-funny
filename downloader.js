...
function runYtDlpCommand(url, outputPath, videoId) {
  return new Promise((resolve, reject) => {
    ...
    const args = [
      ...
      // Eliminamos el argumento --max-duration 59 (problema anterior)
      // ELIMINAMOS TAMBIÉN: '--extractor-args youtube:player_client=default' (problema de metadatos)
      url
    ];
...
const VideoDownloader = {
  ...
  async run(videoList) {
    ...
    // Esta vez, eliminamos el bucle de verificación de duración, ya que falla.
